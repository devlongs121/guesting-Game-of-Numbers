window.addEventListener("load", () => {
    ...
    click.innerHTML = "<a href='game4.html' style='text-decoration:none; color: green';>Next Level</a>"


    const previous = document.createElement("button");
    previous.type = "submit";
    previous.classList = "nextLevel";
    previous.innerHTML = "<a href='game2.html' style='text-decoration:none; color: green';>Prev. Level</a>"
